...
#ifndef TENJINSDK_SWIFT_H
#define TENJINSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TenjinSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9TenjinSDK18EventGatingManager")
@interface EventGatingManager : NSObject <EventGating>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) EventGatingManager * _Nonnull shared;)
+ (EventGatingManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
- (void)handleConnectRequestWithEndpoint:(NSString * _Nonnull)endpoint params:(NSDictionary<NSString *, id> * _Nonnull)params completion:(void (^ _Nonnull)(BOOL))completion;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
