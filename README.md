...
2. Drag `libTenjinSDK.a` and `TenjinSDK.h` to your project ubder build phases -> "Link Binary With Libraries". Note: If you are testing with 32-bit iOS Simulator devices (i386), you will need to use `libTenjinSDKUniversal.a` instead of `libTenjinSDK.a`.
